      ...
      <div className='container py-6 px-4'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          ...
          <div>
            ...
            <p className='text-xs leading-relaxed'>
              {SITE_NAME} - Đọc Truyện Tranh Online Hoàn Toàn Miễn Phí - Nơi Thỏa Mãn Đam Mê.
            </p>
              ...
              <div className='space-y-3'>
                ...
                >
                  ...
                  <span className='text-sm font-medium'>
                    TẢI ỨNG DỤNG {SITE_NAME.toUpperCase()}
                  </span>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
        ...
        <div className='text-center mt-8 pt-6 border-t border-gray-200 dark:border-gray-800'>
          ...
          <p className='text-xs mt-2 text-gray-500 dark:text-gray-400'>
            Copyright © {new Date().getFullYear()} {SITE_NAME}. All Right Reserved
          </p>
        </div>
      </div>
    </footer>
