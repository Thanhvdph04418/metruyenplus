    ...
    <div className='fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm'>
      <div className='bg-white dark:bg-dark-surface rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto'>
        ...
        <div className='p-4 border-t border-gray-200 dark:border-dark-border space-y-2'>
          ...
          <button
            onClick={onClose}
            className='w-full bg-gray-100 dark:bg-dark-highlight hover:bg-gray-200 dark:hover:bg-dark-border text-gray-700 dark:text-gray-300 font-medium py-2 px-4 rounded-lg transition-colors'
          >
            Để sau
          </button>
        </div>
