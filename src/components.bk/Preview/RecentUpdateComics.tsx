      ...
      {data.map((item) => (
        <div key={item.id} className={`col-span-${(12 / perView).toString()}`}>
          <div className='flex'>
            ...
            >
              {item.is_trending && (
                <div className='absolute top-1 right-1 bg-gradient-to-r from-red-500 to-orange-500 text-white px-1.5 py-[1px] text-[10px] z-10 animate-pulse rounded-full font-semibold shadow-lg'>
                  HOT
                </div>
              )}
              <img
            ...
            <div className='pl-[15px] pr-2 leading-5 flex flex-col flex-1 justify-around overflow-hidden'>
              ...
              <div>
                ...
                <p
                  className='line-clamp-2 mt-2 text-black dark:text-white'
