          ...
          {data && (
            <div className='flex items-center gap-[2px] h-full'>
              <div className='w-[339px] h-full'>
                <Link
                  to={`${PATH.comics}/${data[currentIndex].slug}-${data[currentIndex].id}`}
                ...
                <div className='h-[133px] pl-[10px]'>
                  ...
                  <div className='flex items-center gap-5 mt-2'>
                    ...
                    <p className='text-sm block truncate'>
                      ...
                      <Link
                        to={`${PATH.comics}/${data[currentIndex].slug}-${data[currentIndex].id}/${data[currentIndex].last_chapter.slug_chapter}/${data[currentIndex].last_chapter.id}`}
                  ...
                  <p
                    className='text-base text-gray-400 line-clamp-2 mt-2 h-12'
                    dangerouslySetInnerHTML={{
                      __html:
                        data[currentIndex].short_description.length > 150
                          ? data[currentIndex].short_description.slice(0, 150) + '...'
                  ...
                  {data.slice(0, 5).map((item, index) => (
                    ...
                    >
                      <figure className='w-[167px] h-[220px] overflow-hidden'>
                        <Link to={`${PATH.comics}/${item.slug}-${item.id}`} title={item.title}>
                          <img
                            src={item.thumbnail}
                            title={item.title}
                            alt={item.title}
